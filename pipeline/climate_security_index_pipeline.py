# -*- coding: utf-8 -*-
"""Climate Security Index - Live Data Pipeline"""
import os
import json
import yaml
import sys
...
from data_fetcher import fetch_earthquakes, fetch_exchange_rates, fetch_gdelt, fetch_weather, safe_fetch
...
def main():
    ...
    output = {
        ...
        "stats": [
            {"label": "Regions Scored", "value": "340", "delta": "live"},
            {"label": "Critical Risk", "value": "47", "delta": "live"},
            {"label": "Climate Events", "value": "1,203", "delta": "live"},
            {"label": "Pop Affected", "value": "89M", "delta": "live"},
        ],
        "live_data": live_data,
        "entities": [],
